      ...
      <footer className="bg-slate-900 text-slate-400 py-16 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-white text-2xl font-bold mb-6 serif">Lumina Press</h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              {/* Admin Portal link removed from public view as requested */}
            </ul>
          </div>
          <div>
            <h4 className="text-white font-semibold mb-6">Stay Connected</h4>
            <div className="flex flex-col gap-4">
              <input type="email" placeholder="Your email address" className="bg-slate-800 border-none px-4 py-3 rounded text-sm w-full focus:ring-1 focus:ring-slate-500 outline-none" />
              <button className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 rounded transition text-sm">Subscribe</button>
            </div>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 mt-16 pt-8 border-t border-slate-800 text-center text-xs tracking-widest uppercase text-slate-500">
